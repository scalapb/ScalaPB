...
class TypeMappedMarshaller[T <: GeneratedMessage with Message[T], Custom](
  typeMapper: TypeMapper[T, Custom], companion: GeneratedMessageCompanion[T])
...
object Marshaller {
  def forMessage[T <: GeneratedMessage with Message[T]](implicit companion: GeneratedMessageCompanion[T]) =
    new Marshaller[T](companion)

  def forTypeMappedType[T <: GeneratedMessage with Message[T], Custom](
      implicit typeMapper: TypeMapper[T, Custom], companion: GeneratedMessageCompanion[T]) =
