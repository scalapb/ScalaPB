...
object Duration extends scalapb.GeneratedMessageCompanion[_root_.mytypes.duration.Duration] {
  implicit def messageCompanion
      : scalapb.GeneratedMessageCompanion[_root_.mytypes.duration.Duration] = this
  def parseFrom(
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[_root_.mytypes.duration.Duration] =
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor =
    _root_.mytypes.duration.DurationProto.javaDescriptor.getMessageTypes().get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor =
    _root_.mytypes.duration.DurationProto.scalaDescriptor.messages(0)
  ...
  implicit class DurationLens[UpperPB](
      _l: _root_.scalapb.lenses.Lens[UpperPB, _root_.mytypes.duration.Duration]
  ) extends _root_.scalapb.lenses.ObjectLens[UpperPB, _root_.mytypes.duration.Duration](_l) {
