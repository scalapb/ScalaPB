...
final case class MyMessage(
  ...
  def companion: _root_.com.thesamet.docs.json.MyMessage.type =
    _root_.com.thesamet.docs.json.MyMessage
  // @@protoc_insertion_point(GeneratedMessage[com.thesamet.docs.MyMessage])
}

object MyMessage
    extends scalapb.GeneratedMessageCompanion[_root_.com.thesamet.docs.json.MyMessage] {
  implicit def messageCompanion
      : scalapb.GeneratedMessageCompanion[_root_.com.thesamet.docs.json.MyMessage] = this
  def parseFrom(
  ...
  implicit def messageReads
      : _root_.scalapb.descriptors.Reads[_root_.com.thesamet.docs.json.MyMessage] =
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor =
    _root_.com.thesamet.docs.json.JsonProto.javaDescriptor.getMessageTypes().get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor =
    _root_.com.thesamet.docs.json.JsonProto.scalaDescriptor.messages(0)
  ...
  implicit class MyMessageLens[UpperPB](
      _l: _root_.scalapb.lenses.Lens[UpperPB, _root_.com.thesamet.docs.json.MyMessage]
  ) extends _root_.scalapb.lenses.ObjectLens[UpperPB, _root_.com.thesamet.docs.json.MyMessage](_l) {
