...
final case class MyContainer(
  ...
  def withMyAny(__v: com.google.protobuf.any.Any): MyContainer =
...
object MyContainer extends scalapb.GeneratedMessageCompanion[com.thesamet.docs.json.MyContainer] {
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor =
    com.thesamet.docs.json.JsonProto.javaDescriptor.getMessageTypes().get(1)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor =
    com.thesamet.docs.json.JsonProto.scalaDescriptor.messages(1)
