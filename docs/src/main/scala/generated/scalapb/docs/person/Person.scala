...
final case class Person(
  ...
  def addAllAddresses(__vs: Iterable[_root_.scalapb.docs.person.Person.Address]): Person =
    copy(addresses = addresses ++ __vs)
  def withAddresses(__v: _root_.scala.Seq[_root_.scalapb.docs.person.Person.Address]): Person =
    copy(addresses = __v)
...
object Person extends scalapb.GeneratedMessageCompanion[_root_.scalapb.docs.person.Person] {
  implicit def messageCompanion
      : scalapb.GeneratedMessageCompanion[_root_.scalapb.docs.person.Person] = this
  def parseFrom(
      `_input__`: _root_.com.google.protobuf.CodedInputStream
  ): _root_.scalapb.docs.person.Person = {
    var __name: _root_.scala.Predef.String = ""
    var __age: _root_.scala.Int            = 0
    val __addresses: _root_.scala.collection.immutable.VectorBuilder[
      _root_.scalapb.docs.person.Person.Address
    ] =
      new _root_.scala.collection.immutable.VectorBuilder[_root_.scalapb.docs.person.Person.Address]
      ...
      _tag__ match {
        ...
        case 26 =>
          __addresses += _root_.scalapb.LiteParser
            .readMessage[_root_.scalapb.docs.person.Person.Address](_input__)
        case tag =>
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[_root_.scalapb.docs.person.Person] =
      ...
      case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
        ...
        _root_.scalapb.docs.person.Person(
          ...
          addresses = __fieldsMap
            ...
            .map(_.as[_root_.scala.Seq[_root_.scalapb.docs.person.Person.Address]])
            .getOrElse(_root_.scala.Seq.empty)
        )
      case _ => throw new RuntimeException("Expected PMessage")
    }
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor =
    _root_.scalapb.docs.person.PersonProto.javaDescriptor.getMessageTypes().get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor =
    _root_.scalapb.docs.person.PersonProto.scalaDescriptor.messages(0)
  ...
  sealed abstract class AddressType(val value: _root_.scala.Int)
    ...
    def companion: _root_.scalapb.GeneratedEnumCompanion[AddressType] =
      _root_.scalapb.docs.person.Person.AddressType
    final def asRecognized
        : _root_.scala.Option[_root_.scalapb.docs.person.Person.AddressType.Recognized] = if (
      isUnrecognized
    ) _root_.scala.None
    else
      _root_.scala.Some(this.asInstanceOf[_root_.scalapb.docs.person.Person.AddressType.Recognized])
  }
  ...
  object AddressType extends _root_.scalapb.GeneratedEnumCompanion[AddressType] {
    ...
    lazy val values: scala.collection.immutable.Seq[ValueType] =
      scala.collection.immutable.Seq(HOME, WORK)
    ...
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.EnumDescriptor =
      _root_.scalapb.docs.person.Person.javaDescriptor.getEnumTypes().get(0)
    def scalaDescriptor: _root_.scalapb.descriptors.EnumDescriptor =
      _root_.scalapb.docs.person.Person.scalaDescriptor.enums(0)
  }
  @SerialVersionUID(0L)
  final case class Address(
      addressType: _root_.scalapb.docs.person.Person.AddressType =
        _root_.scalapb.docs.person.Person.AddressType.HOME,
    ...
    def withAddressType(__v: _root_.scalapb.docs.person.Person.AddressType): Address =
    ...
    def toProtoString: _root_.scala.Predef.String =
      _root_.scalapb.TextFormat.printToUnicodeString(this)
    def companion: _root_.scalapb.docs.person.Person.Address.type =
      _root_.scalapb.docs.person.Person.Address
    // @@protoc_insertion_point(GeneratedMessage[scalapb.docs.Person.Address])
  }

  object Address
      extends scalapb.GeneratedMessageCompanion[_root_.scalapb.docs.person.Person.Address] {
    implicit def messageCompanion
        : scalapb.GeneratedMessageCompanion[_root_.scalapb.docs.person.Person.Address] = this
    def parseFrom(
        `_input__`: _root_.com.google.protobuf.CodedInputStream
    ): _root_.scalapb.docs.person.Person.Address = {
      var __addressType: _root_.scalapb.docs.person.Person.AddressType =
        _root_.scalapb.docs.person.Person.AddressType.HOME
      ...
      while (!_done__) {
        ...
        _tag__ match {
          ...
          case 8 =>
            __addressType =
              _root_.scalapb.docs.person.Person.AddressType.fromValue(_input__.readEnum())
          case 18 =>
    ...
    implicit def messageReads
        : _root_.scalapb.descriptors.Reads[_root_.scalapb.docs.person.Person.Address] =
      _root_.scalapb.descriptors.Reads {
        case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
          _root_.scala.Predef.require(
            __fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor),
          ...
          _root_.scalapb.docs.person.Person.Address(
            addressType = _root_.scalapb.docs.person.Person.AddressType.fromValue(
              __fieldsMap
                .get(scalaDescriptor.findFieldByNumber(1).get)
                .map(_.as[_root_.scalapb.descriptors.EnumValueDescriptor])
                .getOrElse(_root_.scalapb.docs.person.Person.AddressType.HOME.scalaValueDescriptor)
                .number
            ),
            street = __fieldsMap
              .get(scalaDescriptor.findFieldByNumber(2).get)
    ...
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor =
      _root_.scalapb.docs.person.Person.javaDescriptor.getNestedTypes().get(0)
    def scalaDescriptor: _root_.scalapb.descriptors.Descriptor =
      _root_.scalapb.docs.person.Person.scalaDescriptor.nestedMessages(0)
    def messageCompanionForFieldNumber(
        __number: _root_.scala.Int
    ...
    implicit class AddressLens[UpperPB](
        _l: _root_.scalapb.lenses.Lens[UpperPB, _root_.scalapb.docs.person.Person.Address]
    ) extends _root_.scalapb.lenses.ObjectLens[UpperPB, _root_.scalapb.docs.person.Person.Address](
          _l
        ) {
      def addressType
          : _root_.scalapb.lenses.Lens[UpperPB, _root_.scalapb.docs.person.Person.AddressType] =
  ...
  implicit class PersonLens[UpperPB](
      _l: _root_.scalapb.lenses.Lens[UpperPB, _root_.scalapb.docs.person.Person]
  ) extends _root_.scalapb.lenses.ObjectLens[UpperPB, _root_.scalapb.docs.person.Person](_l) {
