...
final case class SimpleMessage(
  ...
  def companion: _root_.scalapb.perf.protos.SimpleMessage.type =
    _root_.scalapb.perf.protos.SimpleMessage
  // @@protoc_insertion_point(GeneratedMessage[scalapb.perf.SimpleMessage])
}

object SimpleMessage
    extends scalapb.GeneratedMessageCompanion[_root_.scalapb.perf.protos.SimpleMessage] {
  implicit def messageCompanion
      : scalapb.GeneratedMessageCompanion[_root_.scalapb.perf.protos.SimpleMessage] = this
  def parseFrom(
  ...
  implicit def messageReads
      : _root_.scalapb.descriptors.Reads[_root_.scalapb.perf.protos.SimpleMessage] =
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor =
    _root_.scalapb.perf.protos.ProtosProto.javaDescriptor.getMessageTypes().get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor =
    _root_.scalapb.perf.protos.ProtosProto.scalaDescriptor.messages(0)
  ...
  implicit class SimpleMessageLens[UpperPB](
      _l: _root_.scalapb.lenses.Lens[UpperPB, _root_.scalapb.perf.protos.SimpleMessage]
  ) extends _root_.scalapb.lenses.ObjectLens[UpperPB, _root_.scalapb.perf.protos.SimpleMessage](
        _l
      ) {
