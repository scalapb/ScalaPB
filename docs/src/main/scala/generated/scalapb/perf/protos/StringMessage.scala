...
final case class StringMessage(
  ...
  def companion: _root_.scalapb.perf.protos.StringMessage.type =
...
object StringMessage
    extends scalapb.GeneratedMessageCompanion[_root_.scalapb.perf.protos.StringMessage] {
  implicit def messageCompanion
      : scalapb.GeneratedMessageCompanion[_root_.scalapb.perf.protos.StringMessage] = this
  def parseFrom(
  ...
  implicit def messageReads
      : _root_.scalapb.descriptors.Reads[_root_.scalapb.perf.protos.StringMessage] =
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor =
    _root_.scalapb.perf.protos.ProtosProto.javaDescriptor.getMessageTypes().get(5)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor =
    _root_.scalapb.perf.protos.ProtosProto.scalaDescriptor.messages(5)
  ...
  implicit class StringMessageLens[UpperPB](
      _l: _root_.scalapb.lenses.Lens[UpperPB, _root_.scalapb.perf.protos.StringMessage]
  ) extends _root_.scalapb.lenses.ObjectLens[UpperPB, _root_.scalapb.perf.protos.StringMessage](
        _l
      ) {
