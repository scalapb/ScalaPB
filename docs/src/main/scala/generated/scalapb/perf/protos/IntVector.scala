...
object IntVector extends scalapb.GeneratedMessageCompanion[_root_.scalapb.perf.protos.IntVector] {
  implicit def messageCompanion
      : scalapb.GeneratedMessageCompanion[_root_.scalapb.perf.protos.IntVector] = this
  def parseFrom(
  ...
  implicit def messageReads
      : _root_.scalapb.descriptors.Reads[_root_.scalapb.perf.protos.IntVector] =
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor =
    _root_.scalapb.perf.protos.ProtosProto.javaDescriptor.getMessageTypes().get(4)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor =
    _root_.scalapb.perf.protos.ProtosProto.scalaDescriptor.messages(4)
  ...
  implicit class IntVectorLens[UpperPB](
      _l: _root_.scalapb.lenses.Lens[UpperPB, _root_.scalapb.perf.protos.IntVector]
  ) extends _root_.scalapb.lenses.ObjectLens[UpperPB, _root_.scalapb.perf.protos.IntVector](_l) {
