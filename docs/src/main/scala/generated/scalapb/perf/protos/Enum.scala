...
object Enum extends scalapb.GeneratedMessageCompanion[_root_.scalapb.perf.protos.Enum] {
  implicit def messageCompanion
      : scalapb.GeneratedMessageCompanion[_root_.scalapb.perf.protos.Enum] = this
  def parseFrom(
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[_root_.scalapb.perf.protos.Enum] =
    _root_.scalapb.descriptors.Reads {
      case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
        ...
        _root_.scalapb.perf.protos.Enum(
          color = _root_.scalapb.perf.protos.Color.fromValue(
            __fieldsMap
              .get(scalaDescriptor.findFieldByNumber(1).get)
              .map(_.as[_root_.scalapb.descriptors.EnumValueDescriptor])
              .getOrElse(_root_.scalapb.perf.protos.Color.UNKNOWN.scalaValueDescriptor)
              .number
          )
        )
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor =
    _root_.scalapb.perf.protos.ProtosProto.javaDescriptor.getMessageTypes().get(2)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor =
    _root_.scalapb.perf.protos.ProtosProto.scalaDescriptor.messages(2)
  ...
  implicit class EnumLens[UpperPB](
      _l: _root_.scalapb.lenses.Lens[UpperPB, _root_.scalapb.perf.protos.Enum]
  ) extends _root_.scalapb.lenses.ObjectLens[UpperPB, _root_.scalapb.perf.protos.Enum](_l) {
    def color: _root_.scalapb.lenses.Lens[UpperPB, _root_.scalapb.perf.protos.Color] =
