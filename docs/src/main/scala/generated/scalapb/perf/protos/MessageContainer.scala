...
final case class MessageContainer(
  ...
  def withOpt(__v: scalapb.perf.protos.SimpleMessage): MessageContainer =
...
object MessageContainer
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor =
    scalapb.perf.protos.ProtosProto.javaDescriptor.getMessageTypes().get(1)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor =
    scalapb.perf.protos.ProtosProto.scalaDescriptor.messages(1)
