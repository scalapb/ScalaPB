...
sealed abstract class Color(val value: _root_.scala.Int) extends _root_.scalapb.GeneratedEnum {
  ...
  final def asRecognized: _root_.scala.Option[_root_.scalapb.perf.protos.Color.Recognized] = if (
    isUnrecognized
  ) _root_.scala.None
  else _root_.scala.Some(this.asInstanceOf[_root_.scalapb.perf.protos.Color.Recognized])
}
...
object Color extends _root_.scalapb.GeneratedEnumCompanion[Color] {
  ...
  lazy val values: scala.collection.immutable.Seq[ValueType] =
    scala.collection.immutable.Seq(UNKNOWN, RED, GREEN, BLUE)
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.EnumDescriptor =
    _root_.scalapb.perf.protos.ProtosProto.javaDescriptor.getEnumTypes().get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.EnumDescriptor =
    _root_.scalapb.perf.protos.ProtosProto.scalaDescriptor.enums(0)
}
