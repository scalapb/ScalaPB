...
public final class Scalapb {
  ...
  public interface ScalaPbOptionsOrBuilder extends
    ...
    /**
     * <code>optional .scalapb.ScalaPbOptions package_options = 11;</code>
     */
    boolean hasPackageOptions();
    /**
     * <code>optional .scalapb.ScalaPbOptions package_options = 11;</code>
     */
    scalapb.options.compiler.Scalapb.ScalaPbOptions getPackageOptions();
    /**
     * <code>optional .scalapb.ScalaPbOptions package_options = 11;</code>
     */
    scalapb.options.compiler.Scalapb.ScalaPbOptionsOrBuilder getPackageOptionsOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 90: {
              scalapb.options.compiler.Scalapb.ScalaPbOptions.Builder subBuilder = null;
              if (((bitField0_ & 0x00000100) == 0x00000100)) {
                subBuilder = packageOptions_.toBuilder();
              }
              packageOptions_ = input.readMessage(scalapb.options.compiler.Scalapb.ScalaPbOptions.PARSER, extensionRegistry);
              if (subBuilder != null) {
                subBuilder.mergeFrom(packageOptions_);
                packageOptions_ = subBuilder.buildPartial();
              }
    ...
    public static final int PACKAGE_OPTIONS_FIELD_NUMBER = 11;
    private scalapb.options.compiler.Scalapb.ScalaPbOptions packageOptions_;
    /**
     * <code>optional .scalapb.ScalaPbOptions package_options = 11;</code>
     */
     ...
     * <code>optional .scalapb.ScalaPbOptions package_options = 11;</code>
     */
    public scalapb.options.compiler.Scalapb.ScalaPbOptions getPackageOptions() {
      return packageOptions_ == null ? scalapb.options.compiler.Scalapb.ScalaPbOptions.getDefaultInstance() : packageOptions_;
    }
    /**
     * <code>optional .scalapb.ScalaPbOptions package_options = 11;</code>
     */
    public scalapb.options.compiler.Scalapb.ScalaPbOptionsOrBuilder getPackageOptionsOrBuilder() {
      return packageOptions_ == null ? scalapb.options.compiler.Scalapb.ScalaPbOptions.getDefaultInstance() : packageOptions_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (((bitField0_ & 0x00000100) == 0x00000100)) {
        output.writeMessage(11, getPackageOptions());
      }
    ...
    public int getSerializedSize() {
      ...
      if (((bitField0_ & 0x00000100) == 0x00000100)) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(11, getPackageOptions());
      }
      if (((bitField0_ & 0x00000200) == 0x00000200)) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      result = result && (hasPackageOptions() == other.hasPackageOptions());
      if (hasPackageOptions()) {
        result = result && getPackageOptions()
            .equals(other.getPackageOptions());
      }
    ...
    public static final class Builder extends
      ...
      public scalapb.options.compiler.Scalapb.ScalaPbOptions buildPartial() {
        ...
        if (packageOptionsBuilder_ == null) {
          result.packageOptions_ = packageOptions_;
        } else {
          result.packageOptions_ = packageOptionsBuilder_.build();
        }
  ...
  bitField0_ |= 0x00000200;
      ...
      private scalapb.options.compiler.Scalapb.ScalaPbOptions packageOptions_ = null;
      private com.google.protobuf.SingleFieldBuilderV3<
          scalapb.options.compiler.Scalapb.ScalaPbOptions, scalapb.options.compiler.Scalapb.ScalaPbOptions.Builder, scalapb.options.compiler.Scalapb.ScalaPbOptionsOrBuilder> packageOptionsBuilder_;
      /**
       * <code>optional .scalapb.ScalaPbOptions package_options = 11;</code>
       */
      public boolean hasPackageOptions() {
       ...
       * <code>optional .scalapb.ScalaPbOptions package_options = 11;</code>
       */
      public Builder setPackageOptions(scalapb.options.compiler.Scalapb.ScalaPbOptions value) {
        if (packageOptionsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
          packageOptions_ = value;
          onChanged();
        } else {
      ...
      public Builder setPackageOptions(
          scalapb.options.compiler.Scalapb.ScalaPbOptions.Builder builderForValue) {
        if (packageOptionsBuilder_ == null) {
          packageOptions_ = builderForValue.build();
          onChanged();
        } else {
       ...
       * <code>optional .scalapb.ScalaPbOptions package_options = 11;</code>
       */
      public Builder mergePackageOptions(scalapb.options.compiler.Scalapb.ScalaPbOptions value) {
        if (packageOptionsBuilder_ == null) {
          if (((bitField0_ & 0x00000400) == 0x00000400) &&
              packageOptions_ != null &&
              packageOptions_ != scalapb.options.compiler.Scalapb.ScalaPbOptions.getDefaultInstance()) {
            packageOptions_ =
              scalapb.options.compiler.Scalapb.ScalaPbOptions.newBuilder(packageOptions_).mergeFrom(value).buildPartial();
          } else {
            packageOptions_ = value;
          }
          onChanged();
       ...
       * <code>optional .scalapb.ScalaPbOptions package_options = 11;</code>
       */
      public scalapb.options.compiler.Scalapb.ScalaPbOptions.Builder getPackageOptionsBuilder() {
        bitField0_ |= 0x00000400;
        onChanged();
      ...
      public scalapb.options.compiler.Scalapb.ScalaPbOptionsOrBuilder getPackageOptionsOrBuilder() {
        if (packageOptionsBuilder_ != null) {
          ...
          return packageOptions_ == null ?
              scalapb.options.compiler.Scalapb.ScalaPbOptions.getDefaultInstance() : packageOptions_;
        }
      }
      /**
       * <code>optional .scalapb.ScalaPbOptions package_options = 11;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          scalapb.options.compiler.Scalapb.ScalaPbOptions, scalapb.options.compiler.Scalapb.ScalaPbOptions.Builder, scalapb.options.compiler.Scalapb.ScalaPbOptionsOrBuilder> 
          getPackageOptionsFieldBuilder() {
        if (packageOptionsBuilder_ == null) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ckage_options\030\013 \001(\0132\027.scalapb.ScalaPbOpt" +
      "ions\022\'\n\035test_only_no_java_conversions\030\241\215" +
      "\006 \001(\010\"~\n\016MessageOptions\022\017\n\007extends\030\001 \003(\t" +
      "\022\031\n\021companion_extends\030\002 \003(\t\022\023\n\013annotatio" +
      "ns\030\003 \003(\t\022\014\n\004type\030\004 \001(\t\022\035\n\025companion_anno" +
      "tations\030\005 \003(\t\"\224\001\n\014FieldOptions\022\014\n\004type\030\001" +
      ...
      "companion_extends\030\002 \003(\t\022\014\n\004type\030\003 \001(\t\"#\n" +
      "\020EnumValueOptions\022\017\n\007extends\030\001 \003(\t\"\037\n\014On" +
      "eofOptions\022\017\n\007extends\030\001 \003(\t:G\n\007options\022\034" +
      ".google.protobuf.FileOptions\030\374\007 \001(\0132\027.sc" +
      "alapb.ScalaPbOptions:J\n\007message\022\037.google" +
      ".protobuf.MessageOptions\030\374\007 \001(\0132\027.scalap" +
      "b.MessageOptions:D\n\005field\022\035.google.proto" +
      "buf.FieldOptions\030\374\007 \001(\0132\025.scalapb.FieldO" +
      "ptions:I\n\014enum_options\022\034.google.protobuf" +
      ".EnumOptions\030\374\007 \001(\0132\024.scalapb.EnumOption" +
      "s:Q\n\nenum_value\022!.google.protobuf.EnumVa" +
      "lueOptions\030\374\007 \001(\0132\031.scalapb.EnumValueOpt" +
      "ions:D\n\005oneof\022\035.google.protobuf.OneofOpt" +
      "ions\030\374\007 \001(\0132\025.scalapb.OneofOptionsB9\n\030sc" +
      "alapb.options.compiler\342?\034\n\030scalapb.optio" +
      "ns.compiler\020\001"
    };
    ...
    internal_static_scalapb_ScalaPbOptions_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_scalapb_ScalaPbOptions_descriptor,
        new java.lang.String[] { "PackageName", "FlatPackage", "Import", "Preamble", "SingleFile", "NoPrimitiveWrappers", "PrimitiveWrappers", "CollectionType", "PreserveUnknownFields", "ObjectName", "PackageOptions", "TestOnlyNoJavaConversions", });
    internal_static_scalapb_MessageOptions_descriptor =
