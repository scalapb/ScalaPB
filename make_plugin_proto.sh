...
sbt "scalapbcJVM2_12/run --scala_out=scalapb-runtime/src/main/js-native \
    --proto_path=./third_party \
    $GOOGLE_PROTOS"

sbt "scalapbcJVM2_12/run --scala_out=scalapb-runtime/src/main/scala \
    --proto_path=./protobuf:./third_party ./protobuf/scalapb/scalapb.proto"

sbt "scalapbcJVM2_12/run --scala_out=docs/src/main/scala/generated \
