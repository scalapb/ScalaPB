...
object Field extends scalapb.GeneratedMessageCompanion[_root_.com.google.protobuf.`type`.Field] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[_root_.com.google.protobuf.`type`.Field] = this
