...
object Type extends scalapb.GeneratedMessageCompanion[_root_.com.google.protobuf.`type`.Type] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[_root_.com.google.protobuf.`type`.Type] = this
