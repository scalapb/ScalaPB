...
object ScalaPbOptions extends scalapb.GeneratedMessageCompanion[scalapb.options.ScalaPbOptions] with scalapb.HasBuilder[scalapb.options.ScalaPbOptions] {
  ...
  final class Builder private (
    ...
    private var __auxEnumValueOptions: _root_.scala.collection.mutable.Builder[scalapb.options.ScalaPbOptions.AuxEnumValueOptions, _root_.scala.Seq[scalapb.options.ScalaPbOptions.AuxEnumValueOptions]],
