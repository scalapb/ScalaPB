...
object PreprocesserOutput extends scalapb.GeneratedMessageCompanion[scalapb.options.PreprocesserOutput] {
  ...
  final class Builder private (
    private var __optionsByFile: collection.mutable.Builder[(_root_.scala.Predef.String, scalapb.options.ScalaPbOptions), _root_.scala.collection.immutable.Map[_root_.scala.Predef.String, scalapb.options.ScalaPbOptions]],
