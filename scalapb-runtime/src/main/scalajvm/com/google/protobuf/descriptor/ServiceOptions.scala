...
final case class ServiceOptions(
    ...
    def withFeatures(__v: _root_.com.google.protobuf.descriptor.FeatureSet): ServiceOptions = copy(features = _root_.scala.Option(__v))
    ...
    def addUninterpretedOption(__vs: _root_.com.google.protobuf.descriptor.UninterpretedOption *): ServiceOptions = addAllUninterpretedOption(__vs)
    def addAllUninterpretedOption(__vs: Iterable[_root_.com.google.protobuf.descriptor.UninterpretedOption]): ServiceOptions = copy(uninterpretedOption = uninterpretedOption ++ __vs)
    def withUninterpretedOption(__v: _root_.scala.Seq[_root_.com.google.protobuf.descriptor.UninterpretedOption]): ServiceOptions = copy(uninterpretedOption = __v)
    def withUnknownFields(__v: _root_.scalapb.UnknownFieldSet) = copy(unknownFields = __v)
    def discardUnknownFields = copy(unknownFields = _root_.scalapb.UnknownFieldSet.empty)
    def getFieldByNumber(__fieldNumber: _root_.scala.Int): _root_.scala.Any = {
      (__fieldNumber: @_root_.scala.unchecked) match {
        case 34 => features.orNull
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        case 34 => features.map(_.toPMessage).getOrElse(_root_.scalapb.descriptors.PEmpty)
    ...
    def companion: _root_.com.google.protobuf.descriptor.ServiceOptions.type = _root_.com.google.protobuf.descriptor.ServiceOptions
    // @@protoc_insertion_point(GeneratedMessage[google.protobuf.ServiceOptions])
}

object ServiceOptions extends scalapb.GeneratedMessageCompanion[_root_.com.google.protobuf.descriptor.ServiceOptions] with scalapb.JavaProtoSupport[_root_.com.google.protobuf.descriptor.ServiceOptions, com.google.protobuf.DescriptorProtos.ServiceOptions] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[_root_.com.google.protobuf.descriptor.ServiceOptions] with scalapb.JavaProtoSupport[_root_.com.google.protobuf.descriptor.ServiceOptions, com.google.protobuf.DescriptorProtos.ServiceOptions] = this
  def toJavaProto(scalaPbSource: _root_.com.google.protobuf.descriptor.ServiceOptions): com.google.protobuf.DescriptorProtos.ServiceOptions = {
  ...
  def fromJavaProto(javaPbSource: com.google.protobuf.DescriptorProtos.ServiceOptions): _root_.com.google.protobuf.descriptor.ServiceOptions = _root_.com.google.protobuf.descriptor.ServiceOptions(
  ...
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): _root_.com.google.protobuf.descriptor.ServiceOptions = {
    ...
    _root_.com.google.protobuf.descriptor.ServiceOptions(
        features = __features,
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[_root_.com.google.protobuf.descriptor.ServiceOptions] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      _root_.scala.Predef.require(__fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor), "FieldDescriptor does not match message type.")
      _root_.com.google.protobuf.descriptor.ServiceOptions(
        features = __fieldsMap.get(scalaDescriptor.findFieldByNumber(34).get).flatMap(_.as[_root_.scala.Option[_root_.com.google.protobuf.descriptor.FeatureSet]]),
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = _root_.com.google.protobuf.descriptor.DescriptorProtoCompanion.javaDescriptor.getMessageTypes().get(16)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = _root_.com.google.protobuf.descriptor.DescriptorProtoCompanion.scalaDescriptor.messages(16)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = {
    var __out: _root_.scalapb.GeneratedMessageCompanion[_] = null
    (__number: @_root_.scala.unchecked) match {
      case 34 => __out = _root_.com.google.protobuf.descriptor.FeatureSet
  ...
  lazy val defaultInstance = _root_.com.google.protobuf.descriptor.ServiceOptions(
    features = _root_.scala.None,
    deprecated = _root_.scala.None,
    uninterpretedOption = _root_.scala.Vector.empty
  )
  implicit class ServiceOptionsLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, _root_.com.google.protobuf.descriptor.ServiceOptions]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, _root_.com.google.protobuf.descriptor.ServiceOptions](_l) {
  ...
  final val FEATURES_FIELD_NUMBER = 34
