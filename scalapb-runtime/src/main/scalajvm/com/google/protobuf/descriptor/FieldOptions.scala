...
final case class FieldOptions(
    ...
    def withCtype(__v: com.google.protobuf.descriptor.FieldOptions.CType): FieldOptions = copy(ctype = _root_.scala.Option(__v))
    ...
    def withJstype(__v: com.google.protobuf.descriptor.FieldOptions.JSType): FieldOptions = copy(jstype = _root_.scala.Option(__v))
    ...
    def withFeatures(__v: com.google.protobuf.descriptor.FeatureSet): FieldOptions = copy(features = _root_.scala.Option(__v))
...
object FieldOptions extends scalapb.GeneratedMessageCompanion[com.google.protobuf.descriptor.FieldOptions] with scalapb.JavaProtoSupport[com.google.protobuf.descriptor.FieldOptions, com.google.protobuf.DescriptorProtos.FieldOptions] {
  ...
  def toJavaProto(scalaPbSource: com.google.protobuf.descriptor.FieldOptions): com.google.protobuf.DescriptorProtos.FieldOptions = {
    ...
    scalaPbSource.retention.map(com.google.protobuf.descriptor.FieldOptions.OptionRetention.toJavaValue(_)).foreach(javaPbOut.setRetention)
    javaPbOut.addAllTargets(_root_.scalapb.internal.compat.toIterable(scalaPbSource.targets.iterator.map(com.google.protobuf.descriptor.FieldOptions.OptionTargetType.toJavaValue(_))).asJava)
    javaPbOut.addAllEditionDefaults(_root_.scalapb.internal.compat.toIterable(scalaPbSource.editionDefaults.iterator.map(com.google.protobuf.descriptor.FieldOptions.EditionDefault.toJavaProto(_))).asJava)
  ...
  def fromJavaProto(javaPbSource: com.google.protobuf.DescriptorProtos.FieldOptions): com.google.protobuf.descriptor.FieldOptions = com.google.protobuf.descriptor.FieldOptions(
    ...
    retention = if (javaPbSource.hasRetention) Some(com.google.protobuf.descriptor.FieldOptions.OptionRetention.fromJavaValue(javaPbSource.getRetention)) else _root_.scala.None,
    targets = javaPbSource.getTargetsList.asScala.iterator.map(com.google.protobuf.descriptor.FieldOptions.OptionTargetType.fromJavaValue(_)).toSeq,
  ...
  final case class EditionDefault(
      ...
      def withEdition(__v: com.google.protobuf.descriptor.Edition): EditionDefault = copy(edition = _root_.scala.Option(__v))
  ...
  object EditionDefault extends scalapb.GeneratedMessageCompanion[com.google.protobuf.descriptor.FieldOptions.EditionDefault] with scalapb.JavaProtoSupport[com.google.protobuf.descriptor.FieldOptions.EditionDefault, com.google.protobuf.DescriptorProtos.FieldOptions.EditionDefault] {
    implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.google.protobuf.descriptor.FieldOptions.EditionDefault] with scalapb.JavaProtoSupport[com.google.protobuf.descriptor.FieldOptions.EditionDefault, com.google.protobuf.DescriptorProtos.FieldOptions.EditionDefault] = this
    def toJavaProto(scalaPbSource: com.google.protobuf.descriptor.FieldOptions.EditionDefault): com.google.protobuf.DescriptorProtos.FieldOptions.EditionDefault = {
    ...
    def fromJavaProto(javaPbSource: com.google.protobuf.DescriptorProtos.FieldOptions.EditionDefault): com.google.protobuf.descriptor.FieldOptions.EditionDefault = com.google.protobuf.descriptor.FieldOptions.EditionDefault(
  ...
  final case class FeatureSupport(
      ...
      def withEditionIntroduced(__v: com.google.protobuf.descriptor.Edition): FeatureSupport = copy(editionIntroduced = _root_.scala.Option(__v))
      ...
      def withEditionDeprecated(__v: com.google.protobuf.descriptor.Edition): FeatureSupport = copy(editionDeprecated = _root_.scala.Option(__v))
      ...
      def withEditionRemoved(__v: com.google.protobuf.descriptor.Edition): FeatureSupport = copy(editionRemoved = _root_.scala.Option(__v))
      def withUnknownFields(__v: _root_.scalapb.UnknownFieldSet) = copy(unknownFields = __v)
      def discardUnknownFields = copy(unknownFields = _root_.scalapb.UnknownFieldSet.empty)
      def getFieldByNumber(__fieldNumber: _root_.scala.Int): _root_.scala.Any = {
        (__fieldNumber: @_root_.scala.unchecked) match {
  ...
  object FeatureSupport extends scalapb.GeneratedMessageCompanion[com.google.protobuf.descriptor.FieldOptions.FeatureSupport] with scalapb.JavaProtoSupport[com.google.protobuf.descriptor.FieldOptions.FeatureSupport, com.google.protobuf.DescriptorProtos.FieldOptions.FeatureSupport] {
    implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.google.protobuf.descriptor.FieldOptions.FeatureSupport] with scalapb.JavaProtoSupport[com.google.protobuf.descriptor.FieldOptions.FeatureSupport, com.google.protobuf.DescriptorProtos.FieldOptions.FeatureSupport] = this
    def toJavaProto(scalaPbSource: com.google.protobuf.descriptor.FieldOptions.FeatureSupport): com.google.protobuf.DescriptorProtos.FieldOptions.FeatureSupport = {
      val javaPbOut = com.google.protobuf.DescriptorProtos.FieldOptions.FeatureSupport.newBuilder
      scalaPbSource.editionIntroduced.map(com.google.protobuf.descriptor.Edition.toJavaValue(_)).foreach(javaPbOut.setEditionIntroduced)
      scalaPbSource.editionDeprecated.map(com.google.protobuf.descriptor.Edition.toJavaValue(_)).foreach(javaPbOut.setEditionDeprecated)
      scalaPbSource.deprecationWarning.foreach(javaPbOut.setDeprecationWarning)
      scalaPbSource.editionRemoved.map(com.google.protobuf.descriptor.Edition.toJavaValue(_)).foreach(javaPbOut.setEditionRemoved)
      javaPbOut.build
    }
    def fromJavaProto(javaPbSource: com.google.protobuf.DescriptorProtos.FieldOptions.FeatureSupport): com.google.protobuf.descriptor.FieldOptions.FeatureSupport = com.google.protobuf.descriptor.FieldOptions.FeatureSupport(
      editionIntroduced = if (javaPbSource.hasEditionIntroduced) Some(com.google.protobuf.descriptor.Edition.fromJavaValue(javaPbSource.getEditionIntroduced)) else _root_.scala.None,
      editionDeprecated = if (javaPbSource.hasEditionDeprecated) Some(com.google.protobuf.descriptor.Edition.fromJavaValue(javaPbSource.getEditionDeprecated)) else _root_.scala.None,
      deprecationWarning = if (javaPbSource.hasDeprecationWarning) Some(javaPbSource.getDeprecationWarning) else _root_.scala.None,
      editionRemoved = if (javaPbSource.hasEditionRemoved) Some(com.google.protobuf.descriptor.Edition.fromJavaValue(javaPbSource.getEditionRemoved)) else _root_.scala.None
    )
