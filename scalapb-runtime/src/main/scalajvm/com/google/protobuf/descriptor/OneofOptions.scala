...
final case class OneofOptions(
    ...
    def clearFeatures: OneofOptions = copy(features = _root_.scala.None)
    def withFeatures(__v: _root_.com.google.protobuf.descriptor.FeatureSet): OneofOptions = copy(features = _root_.scala.Option(__v))
    def clearUninterpretedOption = copy(uninterpretedOption = _root_.scala.Vector.empty)
    def addUninterpretedOption(__vs: _root_.com.google.protobuf.descriptor.UninterpretedOption *): OneofOptions = addAllUninterpretedOption(__vs)
    def addAllUninterpretedOption(__vs: Iterable[_root_.com.google.protobuf.descriptor.UninterpretedOption]): OneofOptions = copy(uninterpretedOption = uninterpretedOption ++ __vs)
    def withUninterpretedOption(__v: _root_.scala.Seq[_root_.com.google.protobuf.descriptor.UninterpretedOption]): OneofOptions = copy(uninterpretedOption = __v)
    ...
    def companion: _root_.com.google.protobuf.descriptor.OneofOptions.type = _root_.com.google.protobuf.descriptor.OneofOptions
    // @@protoc_insertion_point(GeneratedMessage[google.protobuf.OneofOptions])
}

object OneofOptions extends scalapb.GeneratedMessageCompanion[_root_.com.google.protobuf.descriptor.OneofOptions] with scalapb.JavaProtoSupport[_root_.com.google.protobuf.descriptor.OneofOptions, com.google.protobuf.DescriptorProtos.OneofOptions] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[_root_.com.google.protobuf.descriptor.OneofOptions] with scalapb.JavaProtoSupport[_root_.com.google.protobuf.descriptor.OneofOptions, com.google.protobuf.DescriptorProtos.OneofOptions] = this
  def toJavaProto(scalaPbSource: _root_.com.google.protobuf.descriptor.OneofOptions): com.google.protobuf.DescriptorProtos.OneofOptions = {
  ...
  def fromJavaProto(javaPbSource: com.google.protobuf.DescriptorProtos.OneofOptions): _root_.com.google.protobuf.descriptor.OneofOptions = _root_.com.google.protobuf.descriptor.OneofOptions(
  ...
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): _root_.com.google.protobuf.descriptor.OneofOptions = {
    ...
    _root_.com.google.protobuf.descriptor.OneofOptions(
        features = __features,
        uninterpretedOption = __uninterpretedOption.result(),
        unknownFields = if (_unknownFields__ == null) _root_.scalapb.UnknownFieldSet.empty else _unknownFields__.result()
    )
  }
  implicit def messageReads: _root_.scalapb.descriptors.Reads[_root_.com.google.protobuf.descriptor.OneofOptions] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      _root_.scala.Predef.require(__fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor), "FieldDescriptor does not match message type.")
      _root_.com.google.protobuf.descriptor.OneofOptions(
        features = __fieldsMap.get(scalaDescriptor.findFieldByNumber(1).get).flatMap(_.as[_root_.scala.Option[_root_.com.google.protobuf.descriptor.FeatureSet]]),
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = _root_.com.google.protobuf.descriptor.DescriptorProtoCompanion.javaDescriptor.getMessageTypes().get(13)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = _root_.com.google.protobuf.descriptor.DescriptorProtoCompanion.scalaDescriptor.messages(13)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = {
    var __out: _root_.scalapb.GeneratedMessageCompanion[_] = null
    (__number: @_root_.scala.unchecked) match {
      case 1 => __out = _root_.com.google.protobuf.descriptor.FeatureSet
  ...
  lazy val defaultInstance = _root_.com.google.protobuf.descriptor.OneofOptions(
    features = _root_.scala.None,
    uninterpretedOption = _root_.scala.Vector.empty
  )
  implicit class OneofOptionsLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, _root_.com.google.protobuf.descriptor.OneofOptions]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, _root_.com.google.protobuf.descriptor.OneofOptions](_l) {
