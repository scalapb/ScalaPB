...
object Struct extends scalapb.GeneratedMessageCompanion[_root_.com.google.protobuf.struct.Struct] with scalapb.JavaProtoSupport[_root_.com.google.protobuf.struct.Struct, com.google.protobuf.Struct] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[_root_.com.google.protobuf.struct.Struct] with scalapb.JavaProtoSupport[_root_.com.google.protobuf.struct.Struct, com.google.protobuf.Struct] = this
  def toJavaProto(scalaPbSource: _root_.com.google.protobuf.struct.Struct): com.google.protobuf.Struct = {
    val javaPbOut = com.google.protobuf.Struct.newBuilder
    javaPbOut
      .putAllFields(scalaPbSource.fields.iterator.map {
        __kv => (__kv._1, _root_.com.google.protobuf.struct.Value.toJavaProto(__kv._2))
      }.toMap.asJava)
    javaPbOut.build
  }
  def fromJavaProto(javaPbSource: com.google.protobuf.Struct): _root_.com.google.protobuf.struct.Struct = _root_.com.google.protobuf.struct.Struct(
    fields = javaPbSource.getFieldsMap.asScala.iterator.map(__pv => (__pv._1, _root_.com.google.protobuf.struct.Value.fromJavaProto(__pv._2))).toMap
  )
