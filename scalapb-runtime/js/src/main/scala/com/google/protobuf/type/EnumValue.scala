...
final case class EnumValue(
    ...
    private[this] def __computeSerializedValue(): Int = {
      ...
      if (number != 0) { __size += com.google.protobuf.CodedOutputStream.computeInt32Size(2, number) }
    ...
    def mergeFrom(`_input__`: com.google.protobuf.CodedInputStream): com.google.protobuf.`type`.EnumValue = {
...
object EnumValue extends com.trueaccord.scalapb.GeneratedMessageCompanion[com.google.protobuf.`type`.EnumValue] {
  ...
  def descriptor: com.google.protobuf.Descriptors.Descriptor = TypeProto.descriptor.getMessageTypes.get(3)
  ...
  implicit class EnumValueLens[UpperPB](_l: com.trueaccord.lenses.Lens[UpperPB, com.google.protobuf.`type`.EnumValue]) extends com.trueaccord.lenses.ObjectLens[UpperPB, com.google.protobuf.`type`.EnumValue](_l) {
