...
final case class Struct(
    ...
    private[this] def __computeSerializedValue(): Int = {
      var __size = 0
      fields.foreach(fields => __size += 1 + com.google.protobuf.CodedOutputStream.computeUInt32SizeNoTag(com.google.protobuf.struct.Struct._typemapper_fields.toBase(fields).serializedSize) + com.google.protobuf.struct.Struct._typemapper_fields.toBase(fields).serializedSize)
      __size
    }
    ...
    def mergeFrom(`_input__`: com.google.protobuf.CodedInputStream): com.google.protobuf.struct.Struct = {
      ...
      while (!_done__) {
        ...
        _tag__ match {
          case 0 => _done__ = true
          case 10 =>
            __fields += com.google.protobuf.struct.Struct._typemapper_fields.toCustom(com.trueaccord.scalapb.LiteParser.readMessage(_input__, com.google.protobuf.struct.Struct.FieldsEntry.defaultInstance))
...
object Struct extends com.trueaccord.scalapb.GeneratedMessageCompanion[com.google.protobuf.struct.Struct] {
  ...
  def descriptor: com.google.protobuf.Descriptors.Descriptor = StructProto.descriptor.getMessageTypes.get(0)
  ...
  final case class FieldsEntry(
      ...
      def mergeFrom(`_input__`: com.google.protobuf.CodedInputStream): com.google.protobuf.struct.Struct.FieldsEntry = {
        var __key = this.key
        ...
        while (!_done__) {
          ...
          _tag__ match {
            ...
            case 18 =>
              __value = Some(com.trueaccord.scalapb.LiteParser.readMessage(_input__, __value.getOrElse(com.google.protobuf.struct.Value.defaultInstance)))
            case tag => _input__.skipField(tag)
          }
        }
  ...
  object FieldsEntry extends com.trueaccord.scalapb.GeneratedMessageCompanion[com.google.protobuf.struct.Struct.FieldsEntry] {
    ...
    def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): com.google.protobuf.struct.Struct.FieldsEntry = {
      require(__fieldsMap.keys.forall(_.getContainingType() == descriptor), "FieldDescriptor does not match message type.")
      val __fields = descriptor.getFields
      com.google.protobuf.struct.Struct.FieldsEntry(
    ...
    def descriptor: com.google.protobuf.Descriptors.Descriptor = com.google.protobuf.struct.Struct.descriptor.getNestedTypes.get(0)
    def messageCompanionForField(__field: com.google.protobuf.Descriptors.FieldDescriptor): com.trueaccord.scalapb.GeneratedMessageCompanion[_] = {
      require(__field.getContainingType() == descriptor, "FieldDescriptor does not match message type.")
      var __out: com.trueaccord.scalapb.GeneratedMessageCompanion[_] = null
      __field.getNumber match {
    ...
    implicit class FieldsEntryLens[UpperPB](_l: com.trueaccord.lenses.Lens[UpperPB, com.google.protobuf.struct.Struct.FieldsEntry]) extends com.trueaccord.lenses.ObjectLens[UpperPB, com.google.protobuf.struct.Struct.FieldsEntry](_l) {
      def key: com.trueaccord.lenses.Lens[UpperPB, String] = field(_.key)((c_, f_) => c_.copy(key = f_))
      def value: com.trueaccord.lenses.Lens[UpperPB, com.google.protobuf.struct.Value] = field(_.getValue)((c_, f_) => c_.copy(value = Some(f_)))
      def optionalValue: com.trueaccord.lenses.Lens[UpperPB, scala.Option[com.google.protobuf.struct.Value]] = field(_.value)((c_, f_) => c_.copy(value = f_))
    }
    final val KEY_FIELD_NUMBER = 1
    final val VALUE_FIELD_NUMBER = 2
    implicit val keyValueMapper: com.trueaccord.scalapb.TypeMapper[com.google.protobuf.struct.Struct.FieldsEntry, (String, com.google.protobuf.struct.Value)] =
      com.trueaccord.scalapb.TypeMapper[com.google.protobuf.struct.Struct.FieldsEntry, (String, com.google.protobuf.struct.Value)](__m => (__m.key, __m.getValue))(__p => com.google.protobuf.struct.Struct.FieldsEntry(__p._1, Some(__p._2)))
  }
  
  implicit class StructLens[UpperPB](_l: com.trueaccord.lenses.Lens[UpperPB, com.google.protobuf.struct.Struct]) extends com.trueaccord.lenses.ObjectLens[UpperPB, com.google.protobuf.struct.Struct](_l) {
    def fields: com.trueaccord.lenses.Lens[UpperPB, scala.collection.immutable.Map[String, com.google.protobuf.struct.Value]] = field(_.fields)((c_, f_) => c_.copy(fields = f_))
  }
  final val FIELDS_FIELD_NUMBER = 1
  @transient
  private val _typemapper_fields: com.trueaccord.scalapb.TypeMapper[com.google.protobuf.struct.Struct.FieldsEntry, (String, com.google.protobuf.struct.Value)] = implicitly[com.trueaccord.scalapb.TypeMapper[com.google.protobuf.struct.Struct.FieldsEntry, (String, com.google.protobuf.struct.Value)]]
}
