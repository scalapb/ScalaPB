...
final case class EnumOptions(
    ...
    def withExtends(__v: _root_.scala.collection.immutable.Seq[_root_.scala.Predef.String]): EnumOptions = copy(`extends` = __v)
    ...
    def withCompanionExtends(__v: _root_.scala.collection.immutable.Seq[_root_.scala.Predef.String]): EnumOptions = copy(companionExtends = __v)
