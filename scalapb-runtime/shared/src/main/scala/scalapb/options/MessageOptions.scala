...
final case class MessageOptions(
    ...
    companionExtends: _root_.scala.collection.immutable.Seq[_root_.scala.Predef.String] = _root_.scala.collection.immutable.Seq.empty,
    ...
    companionAnnotations: _root_.scala.collection.immutable.Seq[_root_.scala.Predef.String] = _root_.scala.collection.immutable.Seq.empty
    ...
    def withExtends(__v: _root_.scala.collection.immutable.Seq[_root_.scala.Predef.String]): MessageOptions = copy(`extends` = __v)
    def clearCompanionExtends = copy(companionExtends = _root_.scala.collection.immutable.Seq.empty)
    ...
    def withCompanionExtends(__v: _root_.scala.collection.immutable.Seq[_root_.scala.Predef.String]): MessageOptions = copy(companionExtends = __v)
    ...
    def withAnnotations(__v: _root_.scala.collection.immutable.Seq[_root_.scala.Predef.String]): MessageOptions = copy(annotations = __v)
    ...
    def clearCompanionAnnotations = copy(companionAnnotations = _root_.scala.collection.immutable.Seq.empty)
    ...
    def withCompanionAnnotations(__v: _root_.scala.collection.immutable.Seq[_root_.scala.Predef.String]): MessageOptions = copy(companionAnnotations = __v)
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 2 => _root_.scalapb.descriptors.PRepeated(companionExtends.map(_root_.scalapb.descriptors.PString).to(Vector))
        case 3 => _root_.scalapb.descriptors.PRepeated(annotations.map(_root_.scalapb.descriptors.PString).to(Vector))
        case 4 => `type`.map(_root_.scalapb.descriptors.PString).getOrElse(_root_.scalapb.descriptors.PEmpty)
        case 5 => _root_.scalapb.descriptors.PRepeated(companionAnnotations.map(_root_.scalapb.descriptors.PString).to(Vector))
      }
    }
...
object MessageOptions extends scalapb.GeneratedMessageCompanion[scalapb.options.MessageOptions] {
  ...
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, _root_.scala.Any]): scalapb.options.MessageOptions = {
    ...
    scalapb.options.MessageOptions(
      ...
      __fieldsMap.getOrElse(__fields.get(1), Nil).asInstanceOf[_root_.scala.collection.immutable.Seq[_root_.scala.Predef.String]],
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[scalapb.options.MessageOptions] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      scalapb.options.MessageOptions(
        ...
        __fieldsMap.get(scalaDescriptor.findFieldByNumber(2).get).map(_.as[_root_.scala.collection.immutable.Seq[_root_.scala.Predef.String]]).getOrElse(_root_.scala.collection.immutable.Seq.empty),
  ...
  implicit class MessageOptionsLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, scalapb.options.MessageOptions]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, scalapb.options.MessageOptions](_l) {
    ...
    def companionExtends: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.collection.immutable.Seq[_root_.scala.Predef.String]] = field(_.companionExtends)((c_, f_) => c_.copy(companionExtends = f_))
    ...
    def companionAnnotations: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.collection.immutable.Seq[_root_.scala.Predef.String]] = field(_.companionAnnotations)((c_, f_) => c_.copy(companionAnnotations = f_))
  }
  ...
  def of(
    ...
    companionExtends: _root_.scala.collection.immutable.Seq[_root_.scala.Predef.String],
    ...
    companionAnnotations: _root_.scala.collection.immutable.Seq[_root_.scala.Predef.String]
