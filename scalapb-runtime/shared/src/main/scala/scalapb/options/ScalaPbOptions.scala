...
/** @param packageName
  ...
  * @param oneofsAfterFieldsInConstructor
  *   If true, oneof fields appear last in the constructor parameters list for
  *   generated messages, no matter where they are declared in the proto file.
...
final case class ScalaPbOptions(
    ...
    oneofsAfterFieldsInConstructor: _root_.scala.Option[_root_.scala.Boolean] = _root_.scala.None,
    ...
    private[this] def __computeSerializedValue(): _root_.scala.Int = {
      ...
      if (oneofsAfterFieldsInConstructor.isDefined) {
        val __value = oneofsAfterFieldsInConstructor.get
    ...
    def writeTo(`_output__`: _root_.com.google.protobuf.CodedOutputStream): _root_.scala.Unit = {
      ...
      oneofsAfterFieldsInConstructor.foreach { __v =>
        val __m = __v
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): scalapb.options.ScalaPbOptions = {
      ...
      var __oneofsAfterFieldsInConstructor = this.oneofsAfterFieldsInConstructor
      ...
      while (!_done__) {
        ...
        _tag__ match {
          ...
          case 128 =>
            __oneofsAfterFieldsInConstructor = Option(_input__.readBool())
          case 800008 =>
      ...
      scalapb.options.ScalaPbOptions(
          ...
          oneofsAfterFieldsInConstructor = __oneofsAfterFieldsInConstructor,
    ...
    def getOneofsAfterFieldsInConstructor: _root_.scala.Boolean = oneofsAfterFieldsInConstructor.getOrElse(false)
    def clearOneofsAfterFieldsInConstructor: ScalaPbOptions = copy(oneofsAfterFieldsInConstructor = _root_.scala.None)
    def withOneofsAfterFieldsInConstructor(__v: _root_.scala.Boolean): ScalaPbOptions = copy(oneofsAfterFieldsInConstructor = Option(__v))
    ...
    def getFieldByNumber(__fieldNumber: _root_.scala.Int): _root_.scala.Any = {
      (__fieldNumber: @_root_.scala.unchecked) match {
        ...
        case 16 => oneofsAfterFieldsInConstructor.orNull
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 16 => oneofsAfterFieldsInConstructor.map(_root_.scalapb.descriptors.PBoolean).getOrElse(_root_.scalapb.descriptors.PEmpty)
...
object ScalaPbOptions extends scalapb.GeneratedMessageCompanion[scalapb.options.ScalaPbOptions] {
  ...
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, _root_.scala.Any]): scalapb.options.ScalaPbOptions = {
    ...
    scalapb.options.ScalaPbOptions(
      ...
      oneofsAfterFieldsInConstructor = __fieldsMap.get(__fields.get(15)).asInstanceOf[_root_.scala.Option[_root_.scala.Boolean]],
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[scalapb.options.ScalaPbOptions] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      scalapb.options.ScalaPbOptions(
        ...
        oneofsAfterFieldsInConstructor = __fieldsMap.get(scalaDescriptor.findFieldByNumber(16).get).flatMap(_.as[_root_.scala.Option[_root_.scala.Boolean]]),
  ...
  lazy val defaultInstance = scalapb.options.ScalaPbOptions(
    ...
    oneofsAfterFieldsInConstructor = _root_.scala.None,
  ...
  implicit class ScalaPbOptionsLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, scalapb.options.ScalaPbOptions]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, scalapb.options.ScalaPbOptions](_l) {
    ...
    def oneofsAfterFieldsInConstructor: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Boolean] = field(_.getOneofsAfterFieldsInConstructor)((c_, f_) => c_.copy(oneofsAfterFieldsInConstructor = Option(f_)))
    def optionalOneofsAfterFieldsInConstructor: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Option[_root_.scala.Boolean]] = field(_.oneofsAfterFieldsInConstructor)((c_, f_) => c_.copy(oneofsAfterFieldsInConstructor = f_))
  ...
  final val ONEOFS_AFTER_FIELDS_IN_CONSTRUCTOR_FIELD_NUMBER = 16
  ...
  def of(
    ...
    oneofsAfterFieldsInConstructor: _root_.scala.Option[_root_.scala.Boolean],
    ...
    oneofsAfterFieldsInConstructor,
