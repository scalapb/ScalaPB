...
final case class Enum(
    ...
    enumvalue: _root_.scala.collection.immutable.Seq[com.google.protobuf.`type`.EnumValue] = _root_.scala.collection.immutable.Seq.empty,
    ...
    def clearEnumvalue = copy(enumvalue = _root_.scala.collection.immutable.Seq.empty)
    ...
    def withEnumvalue(__v: _root_.scala.collection.immutable.Seq[com.google.protobuf.`type`.EnumValue]): Enum = copy(enumvalue = __v)
    ...
    def withOptions(__v: _root_.scala.collection.immutable.Seq[com.google.protobuf.`type`.OptionProto]): Enum = copy(options = __v)
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 2 => _root_.scalapb.descriptors.PRepeated(enumvalue.map(_.toPMessage).to(Vector))
...
object Enum extends scalapb.GeneratedMessageCompanion[com.google.protobuf.`type`.Enum] with scalapb.JavaProtoSupport[com.google.protobuf.`type`.Enum, com.google.protobuf.Enum] {
  ...
  def toJavaProto(scalaPbSource: com.google.protobuf.`type`.Enum): com.google.protobuf.Enum = {
    ...
    javaPbOut.addAllEnumvalue(scalaPbSource.enumvalue.map(com.google.protobuf.`type`.EnumValue.toJavaProto).to(_root_.scala.collection.immutable.Seq).asJava)
  ...
  def fromJavaProto(javaPbSource: com.google.protobuf.Enum): com.google.protobuf.`type`.Enum = com.google.protobuf.`type`.Enum(
    ...
    enumvalue = javaPbSource.getEnumvalueList.asScala.map(com.google.protobuf.`type`.EnumValue.fromJavaProto).to(_root_.scala.collection.immutable.Seq),
  ...
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, _root_.scala.Any]): com.google.protobuf.`type`.Enum = {
    ...
    com.google.protobuf.`type`.Enum(
      ...
      __fieldsMap.getOrElse(__fields.get(1), Nil).asInstanceOf[_root_.scala.collection.immutable.Seq[com.google.protobuf.`type`.EnumValue]],
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.google.protobuf.`type`.Enum] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      com.google.protobuf.`type`.Enum(
        ...
        __fieldsMap.get(scalaDescriptor.findFieldByNumber(2).get).map(_.as[_root_.scala.collection.immutable.Seq[com.google.protobuf.`type`.EnumValue]]).getOrElse(_root_.scala.collection.immutable.Seq.empty),
  ...
  implicit class EnumLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.google.protobuf.`type`.Enum]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.google.protobuf.`type`.Enum](_l) {
    ...
    def enumvalue: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.collection.immutable.Seq[com.google.protobuf.`type`.EnumValue]] = field(_.enumvalue)((c_, f_) => c_.copy(enumvalue = f_))
  ...
  def of(
    name: _root_.scala.Predef.String,
    enumvalue: _root_.scala.collection.immutable.Seq[com.google.protobuf.`type`.EnumValue],
