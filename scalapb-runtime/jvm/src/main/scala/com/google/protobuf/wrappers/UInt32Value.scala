...
final class UInt32Value(
    ...
    override def toString(): _root_.scala.Predef.String = s"UInt32Value(${value}, ${unknownFields})"
    def copy(
    ...
    override def equals(__that: _root_.scala.Any): _root_.scala.Boolean = __that match {
      case __that: UInt32Value =>
        this.value == __that.value &&
        this.unknownFields == __that.unknownFields
      case _ => false
    }
    override def hashCode(): _root_.scala.Int = {
      var __hash: _root_.scala.Int = (19 * 41) + com.google.protobuf.wrappers.UInt32Value.scalaDescriptor.hashCode()
...
object UInt32Value extends scalapb.GeneratedMessageCompanion[com.google.protobuf.wrappers.UInt32Value] with scalapb.JavaProtoSupport[com.google.protobuf.wrappers.UInt32Value, com.google.protobuf.UInt32Value] {
  ...
  ): _root_.com.google.protobuf.wrappers.UInt32Value = new _root_.com.google.protobuf.wrappers.UInt32Value(
    value
  )
  def apply(
  ...
  def unapply(__value: _root_.com.google.protobuf.wrappers.UInt32Value): Option[(
    _root_.scala.Int
  )] = Some((
    __value.value
  ))
