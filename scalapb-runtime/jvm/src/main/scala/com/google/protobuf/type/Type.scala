...
object Type extends scalapb.GeneratedMessageCompanion[com.google.protobuf.`type`.Type] with scalapb.JavaProtoSupport[com.google.protobuf.`type`.Type, com.google.protobuf.Type] {
  ...
  def toJavaProto(scalaPbSource: com.google.protobuf.`type`.Type): com.google.protobuf.Type = {
    ...
    javaPbOut.addAllFields(scalaPbSource.fields.map(com.google.protobuf.`type`.Field.toJavaProto).to(_root_.scala.collection.immutable.Seq).asJava)
  ...
  def fromJavaProto(javaPbSource: com.google.protobuf.Type): com.google.protobuf.`type`.Type = com.google.protobuf.`type`.Type(
    ...
    fields = javaPbSource.getFieldsList.asScala.map(com.google.protobuf.`type`.Field.fromJavaProto).to(_root_.scala.collection.immutable.Seq),
    oneofs = javaPbSource.getOneofsList.asScala.map(_root_.scala.Predef.identity).to(_root_.scala.collection.immutable.Seq),
