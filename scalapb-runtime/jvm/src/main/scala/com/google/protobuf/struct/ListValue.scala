...
final case class ListValue(
    values: _root_.scala.collection.immutable.Seq[com.google.protobuf.struct.Value] = _root_.scala.collection.immutable.Seq.empty
    ...
    def clearValues = copy(values = _root_.scala.collection.immutable.Seq.empty)
    ...
    def withValues(__v: _root_.scala.collection.immutable.Seq[com.google.protobuf.struct.Value]): ListValue = copy(values = __v)
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        case 1 => _root_.scalapb.descriptors.PRepeated(values.map(_.toPMessage).to(Vector))
      }
    }
...
object ListValue extends scalapb.GeneratedMessageCompanion[com.google.protobuf.struct.ListValue] with scalapb.JavaProtoSupport[com.google.protobuf.struct.ListValue, com.google.protobuf.ListValue] {
  ...
  def toJavaProto(scalaPbSource: com.google.protobuf.struct.ListValue): com.google.protobuf.ListValue = {
    ...
    javaPbOut.addAllValues(scalaPbSource.values.map(com.google.protobuf.struct.Value.toJavaProto).to(_root_.scala.collection.immutable.Seq).asJava)
    javaPbOut.build
  }
  def fromJavaProto(javaPbSource: com.google.protobuf.ListValue): com.google.protobuf.struct.ListValue = com.google.protobuf.struct.ListValue(
    values = javaPbSource.getValuesList.asScala.map(com.google.protobuf.struct.Value.fromJavaProto).to(_root_.scala.collection.immutable.Seq)
  )
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, _root_.scala.Any]): com.google.protobuf.struct.ListValue = {
    ...
    com.google.protobuf.struct.ListValue(
      __fieldsMap.getOrElse(__fields.get(0), Nil).asInstanceOf[_root_.scala.collection.immutable.Seq[com.google.protobuf.struct.Value]]
    )
  }
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.google.protobuf.struct.ListValue] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      com.google.protobuf.struct.ListValue(
        __fieldsMap.get(scalaDescriptor.findFieldByNumber(1).get).map(_.as[_root_.scala.collection.immutable.Seq[com.google.protobuf.struct.Value]]).getOrElse(_root_.scala.collection.immutable.Seq.empty)
      )
  ...
  implicit class ListValueLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.google.protobuf.struct.ListValue]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.google.protobuf.struct.ListValue](_l) {
    def values: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.collection.immutable.Seq[com.google.protobuf.struct.Value]] = field(_.values)((c_, f_) => c_.copy(values = f_))
  }
  final val VALUES_FIELD_NUMBER = 1
  def of(
    values: _root_.scala.collection.immutable.Seq[com.google.protobuf.struct.Value]
